...
# ========== 本地文件路径 - 支持环境变量、命令行参数、默认路径 ==========
JSON_PATH_ENV = os.environ.get('COACH_RULES_PATH')
JSON_PATH_ARG = sys.argv[1] if len(sys.argv) > 1 else None
...
if JSON_PATH_ENV:
    ...
    # Windows 默认路径（Android 上可通过参数或环境变量指定）
