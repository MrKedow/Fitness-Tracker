    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            title: const Text('关于'),
            subtitle: const Text('项目GitHub地址'),
            onTap: () {
              showAboutDialog(
                context: context,
                applicationName: '健身数据管理系统',
                applicationVersion: 'Android v4.0',
                applicationIcon: const Icon(Icons.fitness_center),
                children: [
                  const Text('本项目是一个开源的健身数据管理工具。'),
                    ...
                    onTap: () async {
                      ...
                      if (mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('形象已更换')));
                      }
                    },
                  )),
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (pickedFile != null) {
                    ...
                    if (mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('自定义形象已添加')));
                    }
                  }
                },
              ),
